...
void main() {
  group("CustomPinPut tests", () {
    testWidgets("CustomPinPut with 4 fields builds correctly", (tester) async {
      final pinPut = CustomPinPut(fieldsCount: 4);
  ...
  testWidgets("PinKeyboard builds correctly", (tester) async {
    final keyboard = PinKeyboard(onNumberKeyPressed: null, onBackPressed: null);
    ...
    expect(find.byIcon(FeatherIcons.delete), findsOneWidget);
  });
}
